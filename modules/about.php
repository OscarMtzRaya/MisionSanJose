    ...
    <div class="themesflat-container">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="content">
                    <div class="heading-section text-center">
                        <div class="sub wow fadeInUp">Our Philosophy</div>
                        <div class="main wow fadeInUp">Every dish is <br> a story</div>
                        <div class="divider wow fadeInUp">
                            <div></div>
                        </div>
                    </div>
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="road-map-item wow fadeInUp">
                    <div class="image">
                        <img src="assets/images/box-item/road-map-1.jpg" alt="">
                    </div>
                    <div class="content">
                        <div class="sub">1996</div>
                        <div class="title"><a href="#">since restaurant</a></div>
                        <p>Morbi non arcu risus quis. Elementum tempus donne egestas sed sed risus pretium quam
                            vulputate. Simul per omittantur voluptatibus viderer vero nam.</p>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="road-map-item wow fadeInUp reverse" data-wow-delay="0.1s">
                    <div class="content">
                        <div class="sub">2004</div>
                        <div class="title"><a href="#">new location</a></div>
                        <p>Morbi non arcu risus quis. Elementum tempus donne egestas sed sed risus pretium quam
                            vulputate. Simul per omittantur voluptatibus viderer vero nam.</p>
                    </div>
                    <div class="image">
                        <img src="assets/images/box-item/road-map-2.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="road-map-item wow fadeInUp" data-wow-delay="0.2s">
                    <div class="image">
                        <img src="assets/images/box-item/road-map-3.jpg" alt="">
                    </div>
                    <div class="content">
                        <div class="sub">2008</div>
                        <div class="title"><a href="#">award restaurant</a></div>
                        <p>Morbi non arcu risus quis. Elementum tempus donne egestas sed sed risus pretium quam
                            vulputate. Simul per omittantur voluptatibus viderer vero nam.</p>
                    </div>
                </div>
