...
<div class="page-title home-2">
                <div class="swiper relative slider-page-title">
                        ...
                        <div class="swiper-slide">
                            <div class="content text-left">
                                <div class="themesflat-container">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="text">Welcome to basilico luxury restaurant</div>
                                            <div class="heading">Flavors for royalty</div>
                                            <p>Craving some delicious Paris food? Maybe you’re in the mood for a juicy steak? No matter what kind of <br> meal you have in mind, The Brochette Restaurant is ready to prepare it for you.</p>
                    ...
                    <div class="swiper-pagination style-number-1 page-title-pagination"></div>
                </div>
            </div>
            <!-- /page-title -->
                ...
                <div class="wrap">
                    <div class="left">
                        <div class="content">
                            <div class="heading-section text-center">
                                ...
                                <div class="main wow fadeInUp">Our Philosophy</div>
                                <div class="divider wow fadeInUp"><div></div></div>
                                <div class="description wow fadeInUp">A place where food, design, and ambiance come together to create a memorable experience.</div>
                            </div>
                    ...
                    <div class="right">
                        <div class="content">
                            ...
                            <p class="wow fadeInUp">“ On holidays is a special day, we will open and with special offer, we will announce ”</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- wg-private-event -->
            <div class="wg-private-event style-1 snare-circle">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="content">
                                <div class="heading-section">
                                    ...
                                    <div class="main wow fadeInUp">Perfect place for special events</div>
                                    <div class="divider wow fadeInUp"><div></div></div>
                                </div>
                                <p class="wow fadeInUp">Whether you're hosting a corporate event, cocktail party, luncheon, dinner, meeting, shower, wedding reception, bat/bar mitzvah or rehearsal dinner, we know we can offer you and your guests a truly memorable event. Nullam sed lacus quis dolor pellentesque lacinia.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="counter-item dot-after">
                                <div class="counter">
                                    <div class="number-counter">
                                        0<span class="number" data-speed="2500" data-to="05" data-inviewport="yes">05</span>
                                    </div>
                                </div>
            ...
            <div class="portfolio-wrap flex">
                <div class="portfolio-item">
                    ...
                    <div class="content">
                        <div class="wrap">
                            <div class="title"><a href="#">honey sauce pizza</a></div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center">
                                ...
                                <div class="text wow fadeInUp">We always give our customers a feeling of peace of mind and comfort when dining at our restaurant <br> Sed ut perspiciatis unde omnis iste natus error voluptate accusantium</div>
                                <div class="divider wow fadeInUp"><div></div></div>
                            </div>
                        </div>
                        <div class="col-12">
                                ...
                                <div class="top">
                                    <ul class="widget-menu-tab">
                                        <li class="item-title active">
                                            <span class="inner">all menu</span>
                                        </li>
                                        <li class="item-title">
            ...
            <div class="wg-chef">
                <div class="top">
                    ...
                    <div class="content">
                        ...
                        <p class="wow fadeInUp">Simple and balanced. Alexander Petillo brings together flavors and specialties from Italy and beyond to create his own culinary world, full of surprising artistry. Vestibulum mollis dolor vel imperdiet lacinia. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="title wow fadeInUp"><a href="#">Good restaurant, delicious food, classy atmosphere</a></div>
                                <p class="wow fadeInUp">Please thank your team for their professional, efficient and friendly service on Sat night.  The chefs smashed it and the drinks flowed freely!  Everyone was impressed and were quite taken with how cost effective it was to have Ochre do what you did.</p>
            ...
            <div class="reservations-location">
                <div class="themesflat-container w1580">
                    <div class="row">
                            ...
                            <div class="wg-reservations pt-0 pb-0">
                                <div class="content">
                                    <div class="heading-section text-center">
                                        ...
                                        <div class="text wow fadeInUp">We will call customers to confirm, so please fill in <br> your name and phone number</div>
                                        <div class="divider wow fadeInUp"><div></div></div>
                                    </div>
                                    <form class="book-form">
                                        ...
                                        <div class="columns">
                                            <fieldset class="phone">
                                                <input type="text" placeholder="Phone*" class="" name="text" tabindex="2" value="" aria-required="true" required="">
                                            </fieldset>
                                        ...
                                        <div class="columns">
                                            ...
                                            <fieldset class="time select">
                                                <input type="date" class="" name="date" tabindex="2" value="2023-06-18" aria-required="true" required="">
                                            </fieldset>
                                        </div>
                                        <div class="bot">
                        ...
                        <div class="col-xl-4">
                            <div class="wg-location pt-0 pb-0">
                                <div class="content">
                                    <div class="heading-section text-center">
                                        <div class="sub wow fadeInUp">Location</div>
                                        <div class="main wow fadeInUp">how to find us</div>
                                        <div class="text wow fadeInUp">It is inconvenient to not know the address, below is the <br> address  and contact of the brochette restaurant</div>
                                        <div class="divider wow fadeInUp"><div></div></div>
                                    </div>
                                    <div class="title wow fadeInUp">book a table & address:</div>
                                    <div class="number wow fadeInUp">+39 399 461 1608</div>
                                    <p class="wow fadeInUp">Basilico Restaurant 767 5th Avenue, Paris 10021, France <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2c6e4d5f4540454f435e495f584d595e4d42586c4b414d4540024f4341">[email&#160;protected]</a></p>
            ...
            <!-- wg-action -->
            <div class="wg-video-full style-1">
                <div class="video-wrap">
                    <a href="https://www.youtube.com/watch?v=eI_LjETc_Ak" class="popup-youtube">
                        <div class="icon">
                            <i class="icon-play3"></i>
