     ...
     <div class="right items-center">
       ...
       <div class="button-right">
         <a target="ref"
           ...
           target="blank" class="button-default mt-0">BOOK A TABLE</a>
       </div>
     </div>
   </div>
       ...
       <div class="header-left">
         <div id="site-logo">
           <a href="index.php" rel="home" class="main-logo">
             <img id="logo_header" alt="" src="assets/images/logo/logo.png" data-retina="assets/images/logo/logo.png"
               class="logo-fixes">
           </a>
         </div><!-- /logo -->
       </div>
       ...
       <div class="relative">
         ...
         <div class="mobile-nav-close">
           <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="white" x="0px"
             y="0px" width="20px" height="20px" viewbox="0 0 122.878 122.88" enable-background="new 0 0 122.878 122.88"
             xml:space="preserve">
             <g>
               <path
