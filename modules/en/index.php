...
<div class="wg-about-hour">
    <div class="wrap">
        ...
        <div class="center">
            <div class="image">
                <img src="assets/images/fotos12feb/14.webp" alt="">
            </div>
        </div>
        <div class="right">
            <div class="content">
                ...
                <div class="widget-tabs style-1">
                    <div class="top">
                        <ul class="widget-menu-tab">
                            ...
                            <li class="item-title">
                                <span class="inner">Cocktails</span>
                            </li>
                        </ul>
                    </div>
                    <div class="bottom pswp-gallery pswp-gallery--single-column" id="gallery--none-transition">
                        ...
                        <div class="widget-content-tab">
                            <div class="widget-content-inner active">
                                <a href="assets/images/menuEng/Comida.webp" data-pswp-width="1669" data-pswp-height="2500"
                                    target="_blank">
                                    <img src="assets/images/menuEng/Comida.webp" alt="">
                                </a>
                            </div>

                            <div class="widget-content-inner">
                                <a href="assets/images/menuEng/Vino.webp" data-pswp-width="1669" data-pswp-height="2500"
                                    target="_blank">
                                    <img src="assets/images/menuEng/Vino.webp" alt="">
                                </a>
                            </div>
                            <div class="widget-content-inner">
                                <a href="assets/images/menuEng/Cocteles.webp" data-pswp-width="1669" data-pswp-height="2500"
                                    target="_blank">
                                    <img src="assets/images/menuEng/Cocteles.webp" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="image border-over-column">
                ...
                <div class="wg-reservations pt-0 pb-0">
                    <div class="content">
                        <div class="heading-section text-center">
                            ...
                            <div class="main wow fadeInUp">book a table</div>
                            <div class="text wow fadeInUp">We will call customers to confirm, so please fill in <br>
                                your name and phone number</div>
                            <div class="divider wow fadeInUp">
                                <div></div>
                            </div>
                        </div>
                        <script type='text/javascript' src='//www.opentable.com.mx/widget/reservation/loader?rid=1365508&type=standard&theme=standard&color=1&dark=false&iframe=true&domain=commx&lang=es-MX&newtab=false&ot_source=Restaurant%20website&cfe=true'></script>
                    </div>
                </div>
            </div>
