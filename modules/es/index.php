          ...
          <div class="themesflat-container">
            <div class="row">
              <div class="col-12">
                ...
                <a class="button-two-line text-white" href="#menu">Ver menú</a>
              </div>
            </div>
          </div>
        </div>
...
<div class="wg-about-hour">
  <div class="wrap">
    <div class="left">
      <div class="content">
        ...
        <p class="wow fadeInUp">
          Disfruta de una gran terraza sobre la plaza donde puedes ver el atardecer iluminar el cielo detrás
          de las montañas mientras observas a locales y turistas disfrutar de su tarde.
        </p>
        <!-- <img class="wow fadeInUp" src="assets/images/item-background/signature.png" alt=""> -->
        <div class="author wow fadeInUp"><a href="https://www.facebook.com/misionsanjoserest" target="_blank">Misión San
            José</a></div>
      </div>
    </div>
    <div class="center">
    ...
    <div class="right">
      <div class="content">
        <div class="heading-section text-center">
          <div class="sub wow fadeInUp">Tiempo de Lujo</div>
          <div class="main wow fadeInUp">Horarios</div>
          <div class="divider wow fadeInUp">
            <div></div>
          </div>
          <div class="description wow fadeInUp">
      ...
      <div class="col-md-6">
        <div class="content">
          <div class="heading-section">
            <div class="sub wow fadeInUp">Eventos privados</div>
            <div class="main wow fadeInUp">
              Lugar perfecto para eventos especiales.
            </div>
            <div class="divider wow fadeInUp">
              <div></div>
            </div>
          ...
          <p class="wow fadeInUp">
            ...
            Cenas románticas, bodas, cumpleaños y eventos especiales.
          </p>
          <a class="button-two-line wow fadeInUp" href="contact.php">Estamos listos para tus eventos.</a>
        </div>
      </div>
      <div class="col-md-6">
    ...
    <div class="row">
      <div class="col-12">
        <div class="heading-section text-center">
          ...
          <div class="main wow fadeInUp">NUESTRO MENÚ</div>
          <div class="text wow fadeInUp">
            Especializados en cócteles y vinos de todo el mundo, tentamos el paladar con una fusión de
            cocina mexicana e italiana.
          </div>
          <div class="divider wow fadeInUp">
            <div></div>
          </div>
    ...
    <div class="row justify-center align-items-center">
      <div class="col-xl-4">
        <div class="wg-reservations pt-0 pb-0">
          <div class="content">
            <div class="heading-section text-center">
              <div class="sub wow fadeInUp">Reservaciones</div>
              <div class="main wow fadeInUp">Reservar una mesa</div>
              <div class="text wow fadeInUp">
                Llamaremos a los clientes para confirmar, así que por favor complete su nombre y número
                de teléfono.
              </div>
              <div class="divider wow fadeInUp">
                <div></div>
            ...
            <div class="bot">
              <a href="https://www.opentable.com.mx/r/mision-san-jose-reservations-san-jose-del-cabo?restref=1365508&lang=es-MX&ot_source=Restaurant%20website" class="button-two-line w-full" style="font-size: 2rem" type="submit" target="blank">Reservar</a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-xl-4" style="padding-top:3rem">
        <div class="relative h-full">
          <iframe
            ...
            width="100%" height="450" style="border:0;border-radius:30px; filter: grayscale(5);" allowfullscreen=""
      ...
      <div class="col-xl-4">
        <div class="wg-location pt-0 pb-0">
          <div class="content">
            <div class="heading-section text-center">
              <div class="sub wow fadeInUp">Dirección</div>
              <div class="main wow fadeInUp">Cómo encontrarnos</div>
              <div class="text wow fadeInUp">
            ...
            <div class="number wow fadeInUp">
              <a href="https://wa.me/+526241096522?text=Hola,%20me%20gustaría%20hacer%20una%20reservación.">
                +52 624 109 6522
              </a>
            </div>
