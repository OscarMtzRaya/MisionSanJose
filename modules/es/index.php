...
<div class="wg-about-hour">
    <div class="wrap">
        ...
        <div class="center">
            <div class="image">
                <img src="assets/images/fotos12feb/11-1.webp" alt="Mision San Jose">
            </div>
        </div>
        <div class="right">
            <div class="content">
                ...
                <div class="wg-reservations pt-0 pb-0">
                    <div class="content">
                        ...
                        <form class="book-form">
                            <fieldset class="name">
                                <input type="text" placeholder="Nombre*" class="" name="name" tabindex="2" value=""
                            ...
                            <div class="columns">
                                <fieldset class="select event-number">
                                    <select class="">
                                        <option value="Subject" selected="">Personas</option>
                            ...
                            <div class="bot">
                                <a href="" class="button-two-line w-full " type="submit">Reservar</a>
                            </div>
                        </form>
                    </div>
                </div>
